      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <ul>
            ...
            <li>
              <a href="{{ route('materialrezerv.index') }}">{{ __('common.materialrezerv_title') }}</a>
              /
              <a href="{{ route('materialrezerv.create') }}">{{ __('common.create') }}</a>
            </li>
            <li>
              <a href="{{ route('punktpriem.index') }}">{{ __('common.punktpriem_title') }}</a>
              /
