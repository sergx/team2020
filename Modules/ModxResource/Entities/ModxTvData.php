...
class ModxTvData extends Model
{
  use \App\Traits\commonModelTrait;

  protected $fillable = [];

  protected $table = "quzat_site_tmplvar_contentvalues";

  public function tvName(){
    return $this->belongsTo('Modules\ModxResource\Entities\ModxTvTech', 'tmplvarid', 'id');
  }
